...
describe "StaticPages" do
  ...
  it "should have the right links on the layout" do
    visit root_path
    click_link "About"
    page.should have_title full_title('About Proman')
    click_link "Help"
    page.should have_title full_title('Help')
    click_link "Contact"
    page.should have_title full_title('Contact Us')
    click_link "Terms of Service"
    page.should have_title full_title('Terms of Service')
    click_link "License"
    page.should have_title full_title('Software License')
    click_link "Proman"
